                ...
                <div class="card-body">
                    <form  class="row" method="POST" action="{{ url('/user/userUpdate') }}">
                        ...
                        <div class="col-6 mb-3">
                            <label for="Viruela Acelga" class="form-label">Apellidos </label>
                        ...
                        <div class="col-2 mb-3">
                            ...
                            <input type="date" class="form-control" id="fechaNacimiento" name="fechaNacimiento"
                                value="10/02/2003" readonly >
                        </div>
                        <div class="col-4 mb-3">
                            <label for="email" class="form-label">Email</label>
                            <input type="text" class="form-control" id="email" name="email"
                                value="pacoviruela@hotmail.com" readonly >
                        </div>
                        ...
                        <div class="col-12 mb-3">
                            ...
                            <textarea class="form-control" id="descripcion" name="descripcion"
                                placeholder="Busco trabajo. Persona responsable." readonly >{{ $usuario->descripcion }} </textarea>
                        </div>
                        ...
                        <div class="col-12 mb-3">
                            ...
                            <textarea class="form-control" id="experienciaLaboral" name="experienciaLaboral"
                                placeholder="Senior developer en React - 4 años" readonly >{{ $usuario->experienciaLaboral }}</textarea>
                        </div>
